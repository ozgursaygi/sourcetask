...
$(document).ready(
  function() {
    ...
    setTimeout(GetNotificationCount, 100);

});

function GetNotificationCount() {

    urlAPI = "/Home/GetNotificationCount?userId=" + activeUserId;
    getAjax(ajaxType.GET, urlAPI, ajaxDataType.JSON, ajaxAsync.TRUE, ajaxShowProgress.TRUE, callbackGetCount, "");
}

function callbackGetCount(result) {

    $("#notificationCountSpan").html(result.count);
    setTimeout(GetNotificationCount, 60000);
}
