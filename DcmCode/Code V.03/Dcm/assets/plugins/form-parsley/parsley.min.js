...
!function (d) {
    var h = function (a) {
        this.messages = {
            defaultMessage: "This value is invalid.", type: { email: "EMail is invalid.", url: "Url is İnvalid.", urlstrict: "This value should be a valid url.", number: "Number is invalid.", digits: "Digits is invalid.", dateIso: "This value should be a valid date (YYYY-MM-DD).", alphanum: "Alphanumeric value is invalid.", phone: "Phone is invalid." }, notnull: "Should not be null.",
            notblank: "should not bu empty.", required: "This value is required.", regexp: "This value seems to be invalid.", min: "Bu alan %s degerinden büyük ya da esit olmalýdýr.", max: "Should be max %s .", range: "Should be between %s - %s.", minlength: "Should be min %s .", maxlength: "Should be max %s.", rangelength: "Should be between %s - %s.",
            mincheck: "Should be select min %s .", maxcheck: "Should be select max %s .", rangecheck: "Should be between %s - %s.", equalto: "Value should be equal."
        }; this.init(a)
    }; h.prototype = {
